...
<?php endif; ?>
  ssl                        on;
<?php if ($nginx_has_realip && $server->http_ssl_proxy_type == Provision_Service_http_public::HOSTING_SERVER_PROXY_XFORWARDEDFOR): ?>
  real_ip_header             X-Forwarded-For;
<?php elseif ($nginx_has_realip && $server->http_ssl_proxy_type == Provision_Service_http_public::HOSTING_SERVER_PROXY_PROXYPROTOCOL): ?>
